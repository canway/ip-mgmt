...
我们欢迎大家贡献代码来使我们的IP管理中心更加强大，代码团队会监控所有的 Pull request, 我们会做相应的代码检查和测试，测试通过之后我们就会接纳 PR ，但是不会立即合并到 master 分支。
...
## 代码协议
[GPL-V3 LICENSE](../LICENSE.txt) 为IP管理中心的开源协议，您贡献的代码也会受此协议保护。
